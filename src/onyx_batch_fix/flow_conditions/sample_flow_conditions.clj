(ns onyx-batch-fix.flow-conditions.sample-flow-conditions)
...
(def flow-conditions
  [{:flow/from :upper-case
    ...
    :flow/post-transform :onyx-batch-fix.flow-conditions.sample-flow-conditions/substitute-segment
    :flow/predicate :onyx-batch-fix.flow-conditions.sample-flow-conditions/npe?
   ...
   {:flow/from :format-line
    ...
    :flow/predicate [:and
                     [:not [:onyx-batch-fix.flow-conditions.sample-flow-conditions/starts-with? :param/disallow-char]]
                     [:onyx-batch-fix.flow-conditions.sample-flow-conditions/within-length? :param/max-line-length]]
